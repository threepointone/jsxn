...
module.exports = function () {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c0 = function peg$c0(xs) {
      return xs.filter(function (x) {
        return typeof x !== 'string' || x.trim().length > 0;
      });
    },
        peg$c1 = function peg$c1(startTag, children, endTag) {
      if (startTag.type != endTag) {
        throw new Error("Expected </" + startTag.type + "> but </" + endTag + "> found.");
      }
      ...
      return _extends({}, startTag, {
        children: children
      });
    },
        peg$c2 = function peg$c2(startTag) {
      return startTag;
    },
        peg$c3 = "=",
        peg$c4 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c5 = function peg$c5(name, val) {
      return { key: name, val: val };
    },
        peg$c6 = function peg$c6(p) {
      return p.reduce(function (o, prop) {
        return o[prop.key] = prop.val, o;
      }, {});
    },
        peg$c7 = "<",
        ...
        peg$c11 = function peg$c11(name, props) {
      return { type: name, props: props };
        ...
        peg$c16 = function peg$c16(name) {
      return name;
    },
        peg$c17 = /^[a-zA-Z]/,
        peg$c18 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
        peg$c19 = function peg$c19(chars) {
      return chars.join("");
    },
        peg$c20 = /^[^<]/,
        peg$c21 = { type: "class", value: "[^<]", description: "[^<]" },
        peg$c22 = function peg$c22(chars) {
      return chars.join("").trim();
        ...
        peg$c28 = function peg$c28(value) {
      return value;
    },
        peg$c29 = "(",
      ...
      return true;
        ...
        peg$c54 = function peg$c54(head, m) {
      return m;
    },
      ...
      return result;
        ...
        peg$c56 = function peg$c56(members) {
      return members !== null ? members : {};
    },
        peg$c57 = function peg$c57(name, value) {
      return { name: name, value: value };
    },
        peg$c58 = function peg$c58(head, v) {
      return v;
    },
        peg$c59 = function peg$c59(head, tail) {
      return [head].concat(tail);
    },
        peg$c60 = function peg$c60(values) {
      ...
      return String.fromCharCode(parseInt(digits, 16));
        ...
        peg$c101 = function peg$c101(sequence) {
      return sequence;
    },
        peg$c102 = /^[^\0-\x1F"\\]/,
